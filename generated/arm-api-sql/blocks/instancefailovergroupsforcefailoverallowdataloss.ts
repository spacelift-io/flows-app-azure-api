...
const InstanceFailoverGroups_ForceFailoverAllowDataLoss: AppBlock = {
  name: "Instance Failover Groups / Force Failover Allow Data Loss",
  description:
...
export default InstanceFailoverGroups_ForceFailoverAllowDataLoss;
