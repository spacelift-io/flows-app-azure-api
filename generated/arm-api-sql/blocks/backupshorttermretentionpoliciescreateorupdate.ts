...
const BackupShortTermRetentionPolicies_CreateOrUpdate: AppBlock = {
  name: "Backup Short Term Retention Policies / Create Or Update",
...
export default BackupShortTermRetentionPolicies_CreateOrUpdate;
