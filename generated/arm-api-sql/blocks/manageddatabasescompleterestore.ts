...
const ManagedDatabases_CompleteRestore: AppBlock = {
  name: "Managed Databases / Complete Restore",
...
export default ManagedDatabases_CompleteRestore;
