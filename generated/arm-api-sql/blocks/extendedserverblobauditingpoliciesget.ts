...
const ExtendedServerBlobAuditingPolicies_Get: AppBlock = {
  name: "Extended Server Blob Auditing Policies / Get",
...
export default ExtendedServerBlobAuditingPolicies_Get;
