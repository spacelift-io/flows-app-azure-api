...
const JobStepExecutions_ListByJobExecution: AppBlock = {
  name: "Job Step Executions / List By Job Execution",
  description: "Lists the step executions of a job execution.",
  category: "Job Step Executions",
  inputs: {
    default: {
      config: {
        serverName: {
...
export default JobStepExecutions_ListByJobExecution;
