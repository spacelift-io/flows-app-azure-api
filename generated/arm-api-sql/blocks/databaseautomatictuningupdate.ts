...
const DatabaseAutomaticTuning_Update: AppBlock = {
  name: "Database Automatic Tuning / Update",
  description: "Update automatic tuning properties for target database.",
  category: "Database Automatic Tuning",
  inputs: {
    default: {
      config: {
        serverName: {
...
export default DatabaseAutomaticTuning_Update;
