...
const ManagedDatabaseTransparentDataEncryption_ListByDatabase: AppBlock = {
  name: "Managed Database Transparent Data Encryption / List By Database",
  description:
    "Gets a list of managed database's transparent data encryptions.",
  category: "Managed Database Transparent Data Encryption",
  inputs: {
    default: {
      config: {
        managedInstanceName: {
...
export default ManagedDatabaseTransparentDataEncryption_ListByDatabase;
