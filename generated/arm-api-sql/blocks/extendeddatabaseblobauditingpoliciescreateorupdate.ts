...
const ExtendedDatabaseBlobAuditingPolicies_CreateOrUpdate: AppBlock = {
  name: "Extended Database Blob Auditing Policies / Create Or Update",
  description:
    "Creates or updates an extended database's blob auditing policy.",
  category: "Extended Database Blob Auditing Policies",
  inputs: {
    default: {
      config: {
        serverName: {
...
export default ExtendedDatabaseBlobAuditingPolicies_CreateOrUpdate;
