...
const WorkloadClassifiers_CreateOrUpdate: AppBlock = {
  name: "Workload Classifiers / Create Or Update",
    ...
    default: {
      config: {
        ...
        workloadClassifierName: {
          name: "Workload Classifier Name",
          description: "Name of the workload classifier",
          type: "string",
          required: true,
        },
        parameters: {
...
export default WorkloadClassifiers_CreateOrUpdate;
