...
const ManagedInstanceEncryptionProtectors_CreateOrUpdate: AppBlock = {
  name: "Managed Instance Encryption Protectors / Create Or Update",
...
export default ManagedInstanceEncryptionProtectors_CreateOrUpdate;
