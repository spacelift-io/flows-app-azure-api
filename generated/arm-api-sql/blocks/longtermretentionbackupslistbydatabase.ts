...
const LongTermRetentionBackups_ListByDatabase: AppBlock = {
  name: "Long Term Retention Backups / List By Database",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        const url =
          `https://management.azure.com/subscriptions/${input.event.inputConfig.subscriptionId || input.app.config.subscriptionId}/providers/Microsoft.Sql/locations/${input.event.inputConfig.locationName}/longTermRetentionServers/${input.event.inputConfig.longTermRetentionServerName}/longTermRetentionDatabases/${input.event.inputConfig.longTermRetentionDatabaseName}/longTermRetentionBackups` +
...
export default LongTermRetentionBackups_ListByDatabase;
