...
const ManagedInstanceLongTermRetentionPolicies_Get: AppBlock = {
  name: "Managed Instance Long Term Retention Policies / Get",
...
export default ManagedInstanceLongTermRetentionPolicies_Get;
