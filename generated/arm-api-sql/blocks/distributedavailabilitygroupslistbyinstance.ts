...
const DistributedAvailabilityGroups_ListByInstance: AppBlock = {
  name: "Distributed Availability Groups / List By Instance",
...
export default DistributedAvailabilityGroups_ListByInstance;
