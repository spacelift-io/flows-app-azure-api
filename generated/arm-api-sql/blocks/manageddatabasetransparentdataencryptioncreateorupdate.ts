...
const ManagedDatabaseTransparentDataEncryption_CreateOrUpdate: AppBlock = {
  name: "Managed Database Transparent Data Encryption / Create Or Update",
  description:
...
export default ManagedDatabaseTransparentDataEncryption_CreateOrUpdate;
