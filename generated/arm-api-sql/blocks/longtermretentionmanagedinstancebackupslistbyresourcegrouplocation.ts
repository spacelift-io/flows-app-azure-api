...
const LongTermRetentionManagedInstanceBackups_ListByResourceGroupLocation: AppBlock =
  {
    name: "Long Term Retention Managed Instance Backups / List By Resource Group Location",
    description:
    ...
    inputs: {
      default: {
        ...
        onEvent: async (input) => {
          const url =
            `https://management.azure.com/subscriptions/${input.event.inputConfig.subscriptionId || input.app.config.subscriptionId}/resourceGroups/${input.event.inputConfig.resourceGroupName || input.app.config.resourceGroupName}/providers/Microsoft.Sql/locations/${input.event.inputConfig.locationName}/longTermRetentionManagedInstanceBackups` +
...
export default LongTermRetentionManagedInstanceBackups_ListByResourceGroupLocation;
