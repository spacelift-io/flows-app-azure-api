...
const ManagedLedgerDigestUploads_CreateOrUpdate: AppBlock = {
  name: "Managed Ledger Digest Uploads / Create Or Update",
  description:
...
export default ManagedLedgerDigestUploads_CreateOrUpdate;
