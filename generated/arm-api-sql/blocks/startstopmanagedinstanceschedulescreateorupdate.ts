...
const StartStopManagedInstanceSchedules_CreateOrUpdate: AppBlock = {
  name: "Start Stop Managed Instance Schedules / Create Or Update",
...
export default StartStopManagedInstanceSchedules_CreateOrUpdate;
