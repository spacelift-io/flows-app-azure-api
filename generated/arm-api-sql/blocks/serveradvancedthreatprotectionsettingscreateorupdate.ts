...
const ServerAdvancedThreatProtectionSettings_CreateOrUpdate: AppBlock = {
  name: "Server Advanced Threat Protection Settings / Create Or Update",
  description: "Creates or updates an Advanced Threat Protection state.",
  category: "Server Advanced Threat Protection Settings",
  inputs: {
    default: {
      config: {
        serverName: {
...
export default ServerAdvancedThreatProtectionSettings_CreateOrUpdate;
