...
const ManagedDatabaseColumns_ListByDatabase: AppBlock = {
  name: "Managed Database Columns / List By Database",
  description: "List managed database columns",
  category: "Managed Database Columns",
  inputs: {
    default: {
      config: {
        managedInstanceName: {
...
export default ManagedDatabaseColumns_ListByDatabase;
