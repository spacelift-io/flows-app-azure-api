...
const ManagedInstancePrivateEndpointConnections_CreateOrUpdate: AppBlock = {
  name: "Managed Instance Private Endpoint Connections / Create Or Update",
  description:
...
export default ManagedInstancePrivateEndpointConnections_CreateOrUpdate;
