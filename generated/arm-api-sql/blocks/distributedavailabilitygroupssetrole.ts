...
const DistributedAvailabilityGroups_SetRole: AppBlock = {
  name: "Distributed Availability Groups / Set Role",
  description:
      ...
      config: {
        ...
        parameters: {
          ...
          type: {
            ...
            required: ["instanceRole", "roleChangeType"],
          },
          required: true,
        },
        subscriptionId: {
...
export default DistributedAvailabilityGroups_SetRole;
