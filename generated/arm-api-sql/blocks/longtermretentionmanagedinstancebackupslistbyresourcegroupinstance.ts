...
const LongTermRetentionManagedInstanceBackups_ListByResourceGroupInstance: AppBlock =
  {
    name: "Long Term Retention Managed Instance Backups / List By Resource Group Instance",
    description:
...
export default LongTermRetentionManagedInstanceBackups_ListByResourceGroupInstance;
