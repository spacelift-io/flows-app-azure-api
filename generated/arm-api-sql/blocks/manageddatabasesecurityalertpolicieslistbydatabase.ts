...
const ManagedDatabaseSecurityAlertPolicies_ListByDatabase: AppBlock = {
  name: "Managed Database Security Alert Policies / List By Database",
...
export default ManagedDatabaseSecurityAlertPolicies_ListByDatabase;
