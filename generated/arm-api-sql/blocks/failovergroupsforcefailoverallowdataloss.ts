...
const FailoverGroups_ForceFailoverAllowDataLoss: AppBlock = {
  name: "Failover Groups / Force Failover Allow Data Loss",
  description:
...
export default FailoverGroups_ForceFailoverAllowDataLoss;
