...
const ManagedBackupShortTermRetentionPolicies_ListByDatabase: AppBlock = {
  name: "Managed Backup Short Term Retention Policies / List By Database",
...
export default ManagedBackupShortTermRetentionPolicies_ListByDatabase;
