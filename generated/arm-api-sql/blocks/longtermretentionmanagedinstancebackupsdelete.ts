...
const LongTermRetentionManagedInstanceBackups_Delete: AppBlock = {
  name: "Long Term Retention Managed Instance Backups / Delete",
...
export default LongTermRetentionManagedInstanceBackups_Delete;
