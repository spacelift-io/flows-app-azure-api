...
const ManagedDatabaseSensitivityLabels_ListByDatabase: AppBlock = {
  name: "Managed Database Sensitivity Labels / List By Database",
...
export default ManagedDatabaseSensitivityLabels_ListByDatabase;
