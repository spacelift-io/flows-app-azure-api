...
const LongTermRetentionManagedInstanceBackups_ListByResourceGroupDatabase: AppBlock =
  {
    name: "Long Term Retention Managed Instance Backups / List By Resource Group Database",
    description:
...
export default LongTermRetentionManagedInstanceBackups_ListByResourceGroupDatabase;
