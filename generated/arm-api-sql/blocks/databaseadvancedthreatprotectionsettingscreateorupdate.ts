...
const DatabaseAdvancedThreatProtectionSettings_CreateOrUpdate: AppBlock = {
  name: "Database Advanced Threat Protection Settings / Create Or Update",
  description:
...
export default DatabaseAdvancedThreatProtectionSettings_CreateOrUpdate;
