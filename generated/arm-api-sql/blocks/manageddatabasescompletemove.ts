...
const ManagedDatabases_CompleteMove: AppBlock = {
  name: "Managed Databases / Complete Move",
      ...
      config: {
        ...
        parameters: {
          ...
          type: {
            ...
            required: ["destinationManagedDatabaseId"],
          },
          required: true,
        },
        subscriptionId: {
...
export default ManagedDatabases_CompleteMove;
