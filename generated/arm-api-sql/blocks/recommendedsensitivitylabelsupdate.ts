...
const RecommendedSensitivityLabels_Update: AppBlock = {
  name: "Recommended Sensitivity Labels / Update",
  description:
    "Update recommended sensitivity labels states of a given database using an operations batch.",
  category: "Recommended Sensitivity Labels",
  inputs: {
    default: {
      config: {
        serverName: {
...
export default RecommendedSensitivityLabels_Update;
