...
const DatabaseBlobAuditingPolicies_CreateOrUpdate: AppBlock = {
  name: "Database Blob Auditing Policies / Create Or Update",
...
export default DatabaseBlobAuditingPolicies_CreateOrUpdate;
