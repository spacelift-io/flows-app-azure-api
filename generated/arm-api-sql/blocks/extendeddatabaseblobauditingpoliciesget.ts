...
const ExtendedDatabaseBlobAuditingPolicies_Get: AppBlock = {
  name: "Extended Database Blob Auditing Policies / Get",
...
export default ExtendedDatabaseBlobAuditingPolicies_Get;
