...
const MaintenanceConfigurations_CreateOrUpdate: AppBlock = {
  name: "Maintenance Configurations / Create Or Update",
  description:
...
export default MaintenanceConfigurations_CreateOrUpdate;
