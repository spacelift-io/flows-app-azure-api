...
const ManagedClusters_List: AppBlock = {
  name: "Managed Clusters / List",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        const url =
          `https://management.azure.com/subscriptions/${input.event.inputConfig.subscriptionId || input.app.config.subscriptionId}/providers/Microsoft.ContainerService/managedClusters` +
...
export default ManagedClusters_List;
