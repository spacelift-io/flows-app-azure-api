...
const BlobContainers_CreateOrUpdateImmutabilityPolicy: AppBlock = {
  name: "Blob Containers / Create Or Update Immutability Policy",
  description:
...
export default BlobContainers_CreateOrUpdateImmutabilityPolicy;
