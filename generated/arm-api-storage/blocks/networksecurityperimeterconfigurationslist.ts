...
const NetworkSecurityPerimeterConfigurations_List: AppBlock = {
  name: "Network Security Perimeter Configurations / List",
  description:
...
export default NetworkSecurityPerimeterConfigurations_List;
