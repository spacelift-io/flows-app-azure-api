...
const BlobContainers_ExtendImmutabilityPolicy: AppBlock = {
  name: "Blob Containers / Extend Immutability Policy",
  description:
...
export default BlobContainers_ExtendImmutabilityPolicy;
