...
const BlobContainers_DeleteImmutabilityPolicy: AppBlock = {
  name: "Blob Containers / Delete Immutability Policy",
  description:
...
export default BlobContainers_DeleteImmutabilityPolicy;
