...
const PrivateEndpointConnections_Put: AppBlock = {
  name: "Private Endpoint Connections / Put",
  description:
...
export default PrivateEndpointConnections_Put;
