...
const Namespaces_CreateOrUpdateAuthorizationRule: AppBlock = {
  name: "Namespaces / Create Or Update Authorization Rule",
...
export default Namespaces_CreateOrUpdateAuthorizationRule;
