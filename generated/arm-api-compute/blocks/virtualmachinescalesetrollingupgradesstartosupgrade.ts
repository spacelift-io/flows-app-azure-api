...
const VirtualMachineScaleSetRollingUpgrades_StartOSUpgrade: AppBlock = {
  name: "Virtual Machine Scale Set Rolling Upgrades / Start OS Upgrade",
  description:
...
export default VirtualMachineScaleSetRollingUpgrades_StartOSUpgrade;
