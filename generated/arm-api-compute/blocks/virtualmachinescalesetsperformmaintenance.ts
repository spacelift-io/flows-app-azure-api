...
const VirtualMachineScaleSets_PerformMaintenance: AppBlock = {
  name: "Virtual Machine Scale Sets / Perform Maintenance",
  description:
...
export default VirtualMachineScaleSets_PerformMaintenance;
