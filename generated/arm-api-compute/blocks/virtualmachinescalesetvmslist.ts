...
const VirtualMachineScaleSetVMs_List: AppBlock = {
  name: "Virtual Machine Scale Set V Ms / List",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        const url =
          `https://management.azure.com/subscriptions/${input.event.inputConfig.subscriptionId || input.app.config.subscriptionId}/resourceGroups/${input.event.inputConfig.resourceGroupName || input.app.config.resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/${input.event.inputConfig.virtualMachineScaleSetName}/virtualMachines` +
...
export default VirtualMachineScaleSetVMs_List;
