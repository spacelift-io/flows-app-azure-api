...
const DiskAccesses_GetAPrivateEndpointConnection: AppBlock = {
  name: "Disk Accesses / Get A Private Endpoint Connection",
  description:
...
export default DiskAccesses_GetAPrivateEndpointConnection;
