...
const GalleryInVMAccessControlProfiles_CreateOrUpdate: AppBlock = {
  name: "Gallery In VM Access Control Profiles / Create Or Update",
...
export default GalleryInVMAccessControlProfiles_CreateOrUpdate;
