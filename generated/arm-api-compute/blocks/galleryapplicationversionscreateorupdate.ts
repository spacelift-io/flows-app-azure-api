...
const GalleryApplicationVersions_CreateOrUpdate: AppBlock = {
  name: "Gallery Application Versions / Create Or Update",
    ...
    default: {
      config: {
        ...
        galleryApplicationVersion: {
          name: "Gallery Application Version",
          type: {
            type: "object",
            properties: {
              properties: {
      ...
      onEvent: async (input) => {
        const requestBody = input.event.inputConfig.galleryApplicationVersion;
...
export default GalleryApplicationVersions_CreateOrUpdate;
