...
const VirtualMachineScaleSetVMs_RetrieveBootDiagnosticsData: AppBlock = {
  name: "Virtual Machine Scale Set V Ms / Retrieve Boot Diagnostics Data",
  description:
...
export default VirtualMachineScaleSetVMs_RetrieveBootDiagnosticsData;
