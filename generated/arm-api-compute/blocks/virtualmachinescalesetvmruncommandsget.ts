...
const VirtualMachineScaleSetVMRunCommands_Get: AppBlock = {
  name: "Virtual Machine Scale Set VM Run Commands / Get",
...
export default VirtualMachineScaleSetVMRunCommands_Get;
