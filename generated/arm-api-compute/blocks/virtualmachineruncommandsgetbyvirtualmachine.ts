...
const VirtualMachineRunCommands_GetByVirtualMachine: AppBlock = {
  name: "Virtual Machine Run Commands / Get By Virtual Machine",
...
export default VirtualMachineRunCommands_GetByVirtualMachine;
