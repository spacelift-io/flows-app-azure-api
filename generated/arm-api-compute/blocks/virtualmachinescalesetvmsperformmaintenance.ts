...
const VirtualMachineScaleSetVMs_PerformMaintenance: AppBlock = {
  name: "Virtual Machine Scale Set V Ms / Perform Maintenance",
...
export default VirtualMachineScaleSetVMs_PerformMaintenance;
