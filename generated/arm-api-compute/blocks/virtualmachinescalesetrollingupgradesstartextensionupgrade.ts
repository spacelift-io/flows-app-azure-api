...
const VirtualMachineScaleSetRollingUpgrades_StartExtensionUpgrade: AppBlock = {
  name: "Virtual Machine Scale Set Rolling Upgrades / Start Extension Upgrade",
  description:
...
export default VirtualMachineScaleSetRollingUpgrades_StartExtensionUpgrade;
