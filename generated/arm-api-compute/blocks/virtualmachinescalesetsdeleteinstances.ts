...
const VirtualMachineScaleSets_DeleteInstances: AppBlock = {
  name: "Virtual Machine Scale Sets / Delete Instances",
...
export default VirtualMachineScaleSets_DeleteInstances;
