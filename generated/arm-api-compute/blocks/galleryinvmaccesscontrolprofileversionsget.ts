...
const GalleryInVMAccessControlProfileVersions_Get: AppBlock = {
  name: "Gallery In VM Access Control Profile Versions / Get",
  description:
...
export default GalleryInVMAccessControlProfileVersions_Get;
