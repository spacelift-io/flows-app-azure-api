...
const GalleryInVMAccessControlProfiles_Delete: AppBlock = {
  name: "Gallery In VM Access Control Profiles / Delete",
...
export default GalleryInVMAccessControlProfiles_Delete;
