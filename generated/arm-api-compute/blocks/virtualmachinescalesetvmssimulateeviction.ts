...
const VirtualMachineScaleSetVMs_SimulateEviction: AppBlock = {
  name: "Virtual Machine Scale Set V Ms / Simulate Eviction",
  description:
...
export default VirtualMachineScaleSetVMs_SimulateEviction;
