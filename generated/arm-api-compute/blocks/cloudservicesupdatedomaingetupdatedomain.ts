...
const CloudServicesUpdateDomain_GetUpdateDomain: AppBlock = {
  name: "Cloud Services Update Domain / Get Update Domain",
  description:
...
export default CloudServicesUpdateDomain_GetUpdateDomain;
