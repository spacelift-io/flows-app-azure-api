...
const ProximityPlacementGroups_CreateOrUpdate: AppBlock = {
  name: "Proximity Placement Groups / Create Or Update",
...
export default ProximityPlacementGroups_CreateOrUpdate;
