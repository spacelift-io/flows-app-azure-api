...
const CapacityReservationGroups_CreateOrUpdate: AppBlock = {
  name: "Capacity Reservation Groups / Create Or Update",
  description:
...
export default CapacityReservationGroups_CreateOrUpdate;
