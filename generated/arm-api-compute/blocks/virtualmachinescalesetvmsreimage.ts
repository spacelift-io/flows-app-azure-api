...
const VirtualMachineScaleSetVMs_Reimage: AppBlock = {
  name: "Virtual Machine Scale Set V Ms / Reimage",
  description:
    ...
    default: {
      config: {
        ...
        vmScaleSetVMReimageInput: {
          name: "VM Scale Set VM Reimage Input",
          type: {
            type: "object",
            properties: {
      ...
      onEvent: async (input) => {
        const requestBody = input.event.inputConfig.vmScaleSetVMReimageInput;
...
export default VirtualMachineScaleSetVMs_Reimage;
