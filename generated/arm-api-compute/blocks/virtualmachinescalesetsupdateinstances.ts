...
const VirtualMachineScaleSets_UpdateInstances: AppBlock = {
  name: "Virtual Machine Scale Sets / Update Instances",
  description:
...
export default VirtualMachineScaleSets_UpdateInstances;
