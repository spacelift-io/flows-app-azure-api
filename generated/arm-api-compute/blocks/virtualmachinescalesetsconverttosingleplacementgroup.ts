...
const VirtualMachineScaleSets_ConvertToSinglePlacementGroup: AppBlock = {
  name: "Virtual Machine Scale Sets / Convert To Single Placement Group",
  description:
...
export default VirtualMachineScaleSets_ConvertToSinglePlacementGroup;
