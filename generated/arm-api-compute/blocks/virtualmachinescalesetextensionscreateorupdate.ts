...
const VirtualMachineScaleSetExtensions_CreateOrUpdate: AppBlock = {
  name: "Virtual Machine Scale Set Extensions / Create Or Update",
...
export default VirtualMachineScaleSetExtensions_CreateOrUpdate;
