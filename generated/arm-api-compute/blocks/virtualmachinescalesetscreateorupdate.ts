...
const VirtualMachineScaleSets_CreateOrUpdate: AppBlock = {
  name: "Virtual Machine Scale Sets / Create Or Update",
...
export default VirtualMachineScaleSets_CreateOrUpdate;
