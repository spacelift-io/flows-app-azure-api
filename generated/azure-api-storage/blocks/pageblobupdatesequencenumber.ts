...
const PageBlob_UpdateSequenceNumber: AppBlock = {
  name: "Page Blob / Update Sequence Number",
  ...
  inputs: {
    default: {
      config: {
        ...
        x_ms_sequence_number_action: {
          name: "Sequence Number Action",
          description:
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.x_ms_sequence_number_action) {
          additionalHeaders["x-ms-sequence-number-action"] = String(
            input.event.inputConfig.x_ms_sequence_number_action,
          );
        }
...
export default PageBlob_UpdateSequenceNumber;
