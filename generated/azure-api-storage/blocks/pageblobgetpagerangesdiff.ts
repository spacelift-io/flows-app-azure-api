...
const PageBlob_GetPageRangesDiff: AppBlock = {
  name: "Page Blob / Get Page Ranges Diff",
  description:
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.x_ms_previous_snapshot_url) {
          additionalHeaders["x-ms-previous-snapshot-url"] = String(
            input.event.inputConfig.x_ms_previous_snapshot_url,
          );
        }
        ...
        const url =
          ...
          (input.event.inputConfig.timeout
            ...
            : "") +
          (input.event.inputConfig.prevsnapshot
            ? `&prevsnapshot=${input.event.inputConfig.prevsnapshot}`
            : "") +
...
export default PageBlob_GetPageRangesDiff;
