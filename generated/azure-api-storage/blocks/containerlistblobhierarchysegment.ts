...
const Container_ListBlobHierarchySegment: AppBlock = {
  name: "Container / List Blob Hierarchy Segment",
  description:
      ...
      onEvent: async (input) => {
        ...
        const url =
          ...
          (input.event.inputConfig.prefix
            ...
            : "") +
          (input.event.inputConfig.delimiter
            ? `&delimiter=${input.event.inputConfig.delimiter}`
            : "") +
...
export default Container_ListBlobHierarchySegment;
