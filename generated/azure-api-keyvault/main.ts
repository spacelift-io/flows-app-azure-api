...
export const app = defineApp({
  ...
  blocks,
  installationInstructions: `Get the token from the Azure OIDC app for the \`keyvault\` service using a signal reference like \`ref("signal.azureOidc.accessTokens").keyvault\`.`,
});
