  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const url = `https://${input.event.inputConfig.storageAccount || input.app.config.storageAccount}.vault.azure.net/certificates/${input.event.inputConfig.certificate_name}/import`;
