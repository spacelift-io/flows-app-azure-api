...
const LoadBalancerBackendAddressPools_List: AppBlock = {
  name: "Load Balancer Backend Address Pools / List",
...
export default LoadBalancerBackendAddressPools_List;
