...
const NetworkManagerRoutingConfigurations_List: AppBlock = {
  name: "Network Manager Routing Configurations / List",
  description:
...
export default NetworkManagerRoutingConfigurations_List;
