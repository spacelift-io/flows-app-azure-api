...
const NetworkWatchers_GetTroubleshooting: AppBlock = {
  name: "Network Watchers / Get Troubleshooting",
...
export default NetworkWatchers_GetTroubleshooting;
