...
const ExpressRouteCrossConnections_UpdateTags: AppBlock = {
  name: "Express Route Cross Connections / Update Tags",
    ...
    default: {
      config: {
        ...
        crossConnectionParameters: {
          name: "Cross Connection Parameters",
          type: "string",
          required: true,
        },
        subscriptionId: {
      ...
      onEvent: async (input) => {
        const requestBody = input.event.inputConfig.crossConnectionParameters;
...
export default ExpressRouteCrossConnections_UpdateTags;
