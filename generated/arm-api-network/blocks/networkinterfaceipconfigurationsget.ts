...
const NetworkInterfaceIPConfigurations_Get: AppBlock = {
  name: "Network Interface IP Configurations / Get",
  description: "Gets the specified network interface ip configuration.",
  category: "Network Interface IP Configurations",
  inputs: {
    default: {
      config: {
...
export default NetworkInterfaceIPConfigurations_Get;
