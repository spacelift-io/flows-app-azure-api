...
const NetworkSecurityPerimeters_CreateOrUpdate: AppBlock = {
  name: "Network Security Perimeters / Create Or Update",
...
export default NetworkSecurityPerimeters_CreateOrUpdate;
