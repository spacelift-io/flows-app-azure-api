...
const VpnLinkConnections_ListDefaultSharedKey: AppBlock = {
  name: "Vpn Link Connections / List Default Shared Key",
  description:
...
export default VpnLinkConnections_ListDefaultSharedKey;
