...
const LoadBalancerFrontendIPConfigurations_Get: AppBlock = {
  name: "Load Balancer Frontend IP Configurations / Get",
  description: "Gets load balancer frontend IP configuration.",
  category: "Load Balancer Frontend IP Configurations",
  inputs: {
    default: {
      config: {
        loadBalancerName: {
        ...
        frontendIPConfigurationName: {
          ...
          description: "Name of the frontend ipconfiguration",
          type: "string",
          required: true,
        },
        subscriptionId: {
...
export default LoadBalancerFrontendIPConfigurations_Get;
