...
const ExpressRouteCircuitAuthorizations_Delete: AppBlock = {
  name: "Express Route Circuit Authorizations / Delete",
  description:
...
export default ExpressRouteCircuitAuthorizations_Delete;
