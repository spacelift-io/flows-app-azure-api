...
const SecurityUserConfigurations_CreateOrUpdate: AppBlock = {
  name: "Security User Configurations / Create Or Update",
  description:
    "Creates or updates a network manager security user configuration.",
  category: "Security User Configurations",
  inputs: {
    default: {
      config: {
        networkManagerName: {
        ...
        securityUserConfiguration: {
          name: "Security User Configuration",
...
export default SecurityUserConfigurations_CreateOrUpdate;
