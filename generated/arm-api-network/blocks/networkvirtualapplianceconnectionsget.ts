...
const NetworkVirtualApplianceConnections_Get: AppBlock = {
  name: "Network Virtual Appliance Connections / Get",
...
export default NetworkVirtualApplianceConnections_Get;
