...
const VpnServerConfigurations_CreateOrUpdate: AppBlock = {
  name: "Vpn Server Configurations / Create Or Update",
  description:
    ...
    default: {
      config: {
        ...
        VpnServerConfigurationParameters: {
          name: "Vpn Server Configuration Parameters",
          type: "string",
          required: true,
        },
        subscriptionId: {
      ...
      onEvent: async (input) => {
        const requestBody =
          input.event.inputConfig.VpnServerConfigurationParameters;
...
export default VpnServerConfigurations_CreateOrUpdate;
