...
const ApplicationGatewayPrivateEndpointConnections_List: AppBlock = {
  name: "Application Gateway Private Endpoint Connections / List",
  description:
...
export default ApplicationGatewayPrivateEndpointConnections_List;
