...
const RoutingRuleCollections_List: AppBlock = {
  name: "Routing Rule Collections / List",
  description:
...
export default RoutingRuleCollections_List;
