...
const LoadBalancerFrontendIPConfigurations_List: AppBlock = {
  name: "Load Balancer Frontend IP Configurations / List",
...
export default LoadBalancerFrontendIPConfigurations_List;
