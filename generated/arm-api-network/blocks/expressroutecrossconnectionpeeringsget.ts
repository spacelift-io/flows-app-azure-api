...
const ExpressRouteCrossConnectionPeerings_Get: AppBlock = {
  name: "Express Route Cross Connection Peerings / Get",
  description:
...
export default ExpressRouteCrossConnectionPeerings_Get;
