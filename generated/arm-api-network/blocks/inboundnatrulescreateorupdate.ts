...
const InboundNatRules_CreateOrUpdate: AppBlock = {
  name: "Inbound Nat Rules / Create Or Update",
  description: "Creates or updates a load balancer inbound NAT rule.",
  category: "Inbound Nat Rules",
  inputs: {
    default: {
      config: {
        loadBalancerName: {
        ...
        inboundNatRuleName: {
          name: "Inbound Nat Rule Name",
          description: "Name of the inbound nat rule",
          type: "string",
          required: true,
        },
        inboundNatRuleParameters: {
          name: "Inbound Nat Rule Parameters",
          type: "string",
          required: true,
        },
        subscriptionId: {
...
export default InboundNatRules_CreateOrUpdate;
