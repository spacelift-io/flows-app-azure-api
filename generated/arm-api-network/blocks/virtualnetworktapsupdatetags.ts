...
const VirtualNetworkTaps_UpdateTags: AppBlock = {
  name: "Virtual Network Taps / Update Tags",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        const requestBody = input.event.inputConfig.tapParameters;
...
export default VirtualNetworkTaps_UpdateTags;
