...
const SecurityUserRuleCollections_List: AppBlock = {
  name: "Security User Rule Collections / List",
  description:
...
export default SecurityUserRuleCollections_List;
