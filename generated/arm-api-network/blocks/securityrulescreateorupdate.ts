...
const SecurityRules_CreateOrUpdate: AppBlock = {
  name: "Security Rules / Create Or Update",
  description:
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        const requestBody = input.event.inputConfig.securityRuleParameters;
...
export default SecurityRules_CreateOrUpdate;
