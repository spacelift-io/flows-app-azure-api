...
const WebApplicationFirewallPolicies_ListAll: AppBlock = {
  name: "Web Application Firewall Policies / List All",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        const url =
          `https://management.azure.com/subscriptions/${input.event.inputConfig.subscriptionId || input.app.config.subscriptionId}/providers/Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies` +
...
export default WebApplicationFirewallPolicies_ListAll;
