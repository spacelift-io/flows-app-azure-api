...
const FirewallPolicyIdpsSignaturesOverrides_Put: AppBlock = {
  name: "Firewall Policy Idps Signatures Overrides / Put",
  description:
...
export default FirewallPolicyIdpsSignaturesOverrides_Put;
