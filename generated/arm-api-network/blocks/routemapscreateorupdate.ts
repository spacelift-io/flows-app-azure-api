...
const RouteMaps_CreateOrUpdate: AppBlock = {
  name: "Route Maps / Create Or Update",
  description:
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        const requestBody = input.event.inputConfig.routeMapParameters;
...
export default RouteMaps_CreateOrUpdate;
