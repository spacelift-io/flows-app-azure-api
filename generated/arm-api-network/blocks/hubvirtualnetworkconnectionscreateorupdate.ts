...
const HubVirtualNetworkConnections_CreateOrUpdate: AppBlock = {
  name: "Hub Virtual Network Connections / Create Or Update",
  description:
    ...
    default: {
      config: {
        ...
        hubVirtualNetworkConnectionParameters: {
          name: "Hub Virtual Network Connection Parameters",
          type: "string",
          required: true,
        },
        subscriptionId: {
      ...
      onEvent: async (input) => {
        const requestBody =
          input.event.inputConfig.hubVirtualNetworkConnectionParameters;
...
export default HubVirtualNetworkConnections_CreateOrUpdate;
