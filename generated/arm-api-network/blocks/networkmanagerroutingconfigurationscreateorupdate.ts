...
const NetworkManagerRoutingConfigurations_CreateOrUpdate: AppBlock = {
  name: "Network Manager Routing Configurations / Create Or Update",
  description: "Creates or updates a network manager routing configuration.",
  category: "Network Manager Routing Configurations",
  inputs: {
    default: {
      config: {
        networkManagerName: {
...
export default NetworkManagerRoutingConfigurations_CreateOrUpdate;
