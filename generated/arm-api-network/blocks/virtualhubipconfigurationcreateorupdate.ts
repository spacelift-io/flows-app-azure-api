...
const VirtualHubIpConfiguration_CreateOrUpdate: AppBlock = {
  name: "Virtual Hub Ip Configuration / Create Or Update",
  description:
...
export default VirtualHubIpConfiguration_CreateOrUpdate;
