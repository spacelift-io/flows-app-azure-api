...
const PrivateLinkServices_UpdatePrivateEndpointConnection: AppBlock = {
  name: "Private Link Services / Update Private Endpoint Connection",
  description:
...
export default PrivateLinkServices_UpdatePrivateEndpointConnection;
