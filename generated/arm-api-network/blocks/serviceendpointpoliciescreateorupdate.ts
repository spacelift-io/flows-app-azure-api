...
const ServiceEndpointPolicies_CreateOrUpdate: AppBlock = {
  name: "Service Endpoint Policies / Create Or Update",
...
export default ServiceEndpointPolicies_CreateOrUpdate;
