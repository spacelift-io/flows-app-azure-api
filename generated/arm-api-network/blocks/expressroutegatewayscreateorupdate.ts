...
const ExpressRouteGateways_CreateOrUpdate: AppBlock = {
  name: "Express Route Gateways / Create Or Update",
  description:
    ...
    default: {
      config: {
        ...
        putExpressRouteGatewayParameters: {
          name: "Put Express Route Gateway Parameters",
          type: "string",
          required: true,
        },
        subscriptionId: {
      ...
      onEvent: async (input) => {
        const requestBody =
          input.event.inputConfig.putExpressRouteGatewayParameters;
...
export default ExpressRouteGateways_CreateOrUpdate;
