...
const VpnLinkConnections_GetDefaultSharedKey: AppBlock = {
  name: "Vpn Link Connections / Get Default Shared Key",
...
export default VpnLinkConnections_GetDefaultSharedKey;
