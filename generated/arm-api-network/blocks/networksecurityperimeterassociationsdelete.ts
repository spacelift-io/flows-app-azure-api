...
const NetworkSecurityPerimeterAssociations_Delete: AppBlock = {
  name: "Network Security Perimeter Associations / Delete",
...
export default NetworkSecurityPerimeterAssociations_Delete;
