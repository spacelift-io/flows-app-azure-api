...
const NetworkManagerRoutingConfigurations_Get: AppBlock = {
  name: "Network Manager Routing Configurations / Get",
...
export default NetworkManagerRoutingConfigurations_Get;
