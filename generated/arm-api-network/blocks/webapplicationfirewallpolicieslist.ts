...
const WebApplicationFirewallPolicies_List: AppBlock = {
  name: "Web Application Firewall Policies / List",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        const url =
          `https://management.azure.com/subscriptions/${input.event.inputConfig.subscriptionId || input.app.config.subscriptionId}/resourceGroups/${input.event.inputConfig.resourceGroupName || input.app.config.resourceGroupName}/providers/Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies` +
...
export default WebApplicationFirewallPolicies_List;
