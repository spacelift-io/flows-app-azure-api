...
const NetworkInterfaceLoadBalancers_List: AppBlock = {
  name: "Network Interface Load Balancers / List",
  description: "List all load balancers in a network interface.",
  category: "Network Interface Load Balancers",
  inputs: {
    default: {
      config: {
...
export default NetworkInterfaceLoadBalancers_List;
