...
const ExpressRouteCrossConnectionPeerings_CreateOrUpdate: AppBlock = {
  name: "Express Route Cross Connection Peerings / Create Or Update",
  description:
...
export default ExpressRouteCrossConnectionPeerings_CreateOrUpdate;
