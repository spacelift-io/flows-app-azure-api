...
const PrivateLinkServices_GetPrivateEndpointConnection: AppBlock = {
  name: "Private Link Services / Get Private Endpoint Connection",
  description:
...
export default PrivateLinkServices_GetPrivateEndpointConnection;
