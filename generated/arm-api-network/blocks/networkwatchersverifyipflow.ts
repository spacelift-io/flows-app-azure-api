...
const NetworkWatchers_VerifyIPFlow: AppBlock = {
  name: "Network Watchers / Verify IP Flow",
  description:
...
export default NetworkWatchers_VerifyIPFlow;
