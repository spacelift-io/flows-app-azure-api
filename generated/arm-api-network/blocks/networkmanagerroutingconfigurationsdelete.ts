...
const NetworkManagerRoutingConfigurations_Delete: AppBlock = {
  name: "Network Manager Routing Configurations / Delete",
...
export default NetworkManagerRoutingConfigurations_Delete;
