...
const LoadBalancerNetworkInterfaces_List: AppBlock = {
  name: "Load Balancer Network Interfaces / List",
  description: "Gets associated load balancer network interfaces.",
  category: "Load Balancer Network Interfaces",
  inputs: {
    default: {
      config: {
        loadBalancerName: {
...
export default LoadBalancerNetworkInterfaces_List;
