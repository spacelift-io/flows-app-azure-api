...
const P2sVpnGateways_CreateOrUpdate: AppBlock = {
  name: "P2s Vpn Gateways / Create Or Update",
  description:
    ...
    default: {
      config: {
        ...
        p2SVpnGatewayParameters: {
          name: "P2s Vpn Gateway Parameters",
          type: "string",
          required: true,
        },
        subscriptionId: {
      ...
      onEvent: async (input) => {
        const requestBody = input.event.inputConfig.p2SVpnGatewayParameters;
...
export default P2sVpnGateways_CreateOrUpdate;
