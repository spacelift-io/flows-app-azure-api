...
const VirtualNetworkGateways_CreateOrUpdate: AppBlock = {
  name: "Virtual Network Gateways / Create Or Update",
  description:
...
export default VirtualNetworkGateways_CreateOrUpdate;
