...
const VirtualNetworkGatewayConnections_CreateOrUpdate: AppBlock = {
  name: "Virtual Network Gateway Connections / Create Or Update",
  description:
...
export default VirtualNetworkGatewayConnections_CreateOrUpdate;
