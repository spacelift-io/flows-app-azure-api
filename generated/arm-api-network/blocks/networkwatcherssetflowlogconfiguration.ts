...
const NetworkWatchers_SetFlowLogConfiguration: AppBlock = {
  name: "Network Watchers / Set Flow Log Configuration",
  description:
...
export default NetworkWatchers_SetFlowLogConfiguration;
