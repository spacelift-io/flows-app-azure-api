...
const VirtualNetworkGatewayConnections_Delete: AppBlock = {
  name: "Virtual Network Gateway Connections / Delete",
...
export default VirtualNetworkGatewayConnections_Delete;
