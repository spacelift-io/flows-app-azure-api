...
const VirtualNetworkGatewayConnections_GetSharedKey: AppBlock = {
  name: "Virtual Network Gateway Connections / Get Shared Key",
  description:
...
export default VirtualNetworkGatewayConnections_GetSharedKey;
