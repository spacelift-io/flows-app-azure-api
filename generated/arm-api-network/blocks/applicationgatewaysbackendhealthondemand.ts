...
const ApplicationGateways_BackendHealthOnDemand: AppBlock = {
  name: "Application Gateways / Backend Health On Demand",
  description:
...
export default ApplicationGateways_BackendHealthOnDemand;
