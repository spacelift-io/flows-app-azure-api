...
const AdminRuleCollections_CreateOrUpdate: AppBlock = {
  name: "Admin Rule Collections / Create Or Update",
  description: "Creates or updates an admin rule collection.",
  category: "Admin Rule Collections",
  inputs: {
    default: {
      config: {
        networkManagerName: {
...
export default AdminRuleCollections_CreateOrUpdate;
