...
const NetworkSecurityPerimeterLinks_CreateOrUpdate: AppBlock = {
  name: "Network Security Perimeter Links / Create Or Update",
...
export default NetworkSecurityPerimeterLinks_CreateOrUpdate;
