...
const ManagementGroupNetworkManagerConnections_CreateOrUpdate: AppBlock = {
  name: "Management Group Network Manager Connections / Create Or Update",
...
export default ManagementGroupNetworkManagerConnections_CreateOrUpdate;
