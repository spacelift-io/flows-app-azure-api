...
const NetworkSecurityPerimeterLoggingConfigurations_Get: AppBlock = {
  name: "Network Security Perimeter Logging Configurations / Get",
...
export default NetworkSecurityPerimeterLoggingConfigurations_Get;
