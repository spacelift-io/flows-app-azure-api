...
const Registries_Update: AppBlock = {
    ...
    default: {
      config: {
        ...
        registryUpdateParameters: {
          name: "Registry Update Parameters",
          type: {
            type: "object",
            properties: {
              identity: {
      ...
      onEvent: async (input) => {
        const requestBody = input.event.inputConfig.registryUpdateParameters;
...
export default Registries_Update;
