...
const CacheRules_Create: AppBlock = {
  name: "Cache Rules / Create",
  description:
    ...
    default: {
      config: {
        ...
        cacheRuleCreateParameters: {
          name: "Cache Rule Create Parameters",
          type: {
            type: "object",
            properties: {
              properties: {
      ...
      onEvent: async (input) => {
        const requestBody = input.event.inputConfig.cacheRuleCreateParameters;
...
export default CacheRules_Create;
