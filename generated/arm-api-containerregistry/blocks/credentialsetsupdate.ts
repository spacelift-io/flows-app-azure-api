...
const CredentialSets_Update: AppBlock = {
  name: "Credential Sets / Update",
  description:
    ...
    default: {
      config: {
        ...
        credentialSetUpdateParameters: {
          name: "Credential Set Update Parameters",
          type: {
            type: "object",
            properties: {
              properties: {
      ...
      onEvent: async (input) => {
        const requestBody =
          input.event.inputConfig.credentialSetUpdateParameters;
...
export default CredentialSets_Update;
