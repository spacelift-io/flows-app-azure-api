...
const ConnectedRegistries_Update: AppBlock = {
  name: "Connected Registries / Update",
    ...
    default: {
      config: {
        ...
        connectedRegistryUpdateParameters: {
          name: "Connected Registry Update Parameters",
          type: {
            type: "object",
            properties: {
              properties: {
      ...
      onEvent: async (input) => {
        const requestBody =
          input.event.inputConfig.connectedRegistryUpdateParameters;
...
export default ConnectedRegistries_Update;
