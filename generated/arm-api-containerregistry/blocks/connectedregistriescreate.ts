...
const ConnectedRegistries_Create: AppBlock = {
  name: "Connected Registries / Create",
  description:
    ...
    default: {
      config: {
        ...
        connectedRegistryCreateParameters: {
          name: "Connected Registry Create Parameters",
          type: {
            type: "object",
            properties: {
              properties: {
      ...
      onEvent: async (input) => {
        const requestBody =
          input.event.inputConfig.connectedRegistryCreateParameters;
...
export default ConnectedRegistries_Create;
