...
const Webhooks_Update: AppBlock = {
    ...
    default: {
      config: {
        ...
        webhookUpdateParameters: {
          name: "Webhook Update Parameters",
          type: {
            type: "object",
            properties: {
              tags: {
      ...
      onEvent: async (input) => {
        const requestBody = input.event.inputConfig.webhookUpdateParameters;
...
export default Webhooks_Update;
