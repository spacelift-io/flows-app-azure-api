...
const WebApps_CreateOrUpdateConfigurationSlot: AppBlock = {
  name: "Web Apps / Create Or Update Configuration Slot",
...
export default WebApps_CreateOrUpdateConfigurationSlot;
