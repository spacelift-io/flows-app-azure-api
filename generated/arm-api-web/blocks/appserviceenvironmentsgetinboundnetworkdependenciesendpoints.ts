...
const AppServiceEnvironments_GetInboundNetworkDependenciesEndpoints: AppBlock =
  {
    name: "App Service Environments / Get Inbound Network Dependencies Endpoints",
    description:
...
export default AppServiceEnvironments_GetInboundNetworkDependenciesEndpoints;
