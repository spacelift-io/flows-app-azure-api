...
const StaticSites_GetUserProvidedFunctionAppForStaticSiteBuild: AppBlock = {
  name: "Static Sites / Get User Provided Function App For Static Site Build",
  description:
...
export default StaticSites_GetUserProvidedFunctionAppForStaticSiteBuild;
