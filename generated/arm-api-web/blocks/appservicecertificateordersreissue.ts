...
const AppServiceCertificateOrders_Reissue: AppBlock = {
  name: "App Service Certificate Orders / Reissue",
    ...
    default: {
      config: {
        ...
        reissueCertificateOrderRequest: {
          name: "Reissue Certificate Order Request",
          type: {
            type: "object",
            properties: {
              properties: {
...
export default AppServiceCertificateOrders_Reissue;
