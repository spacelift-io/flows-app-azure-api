...
const SiteCertificates_CreateOrUpdateSlot: AppBlock = {
  name: "Site Certificates / Create Or Update Slot",
  description:
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const url =
          `https://management.azure.com/subscriptions/${input.event.inputConfig.subscriptionId || input.app.config.subscriptionId}/resourceGroups/${input.event.inputConfig.resourceGroupName || input.app.config.resourceGroupName}/providers/Microsoft.Web/sites/${input.event.inputConfig.name}/slots/${input.event.inputConfig.slot}/certificates/${input.event.inputConfig.certificateName}` +
...
export default SiteCertificates_CreateOrUpdateSlot;
