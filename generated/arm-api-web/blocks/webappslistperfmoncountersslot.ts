...
const WebApps_ListPerfMonCountersSlot: AppBlock = {
  name: "Web Apps / List Perf Mon Counters Slot",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        const url =
          `https://management.azure.com/subscriptions/${input.event.inputConfig.subscriptionId || input.app.config.subscriptionId}/resourceGroups/${input.event.inputConfig.resourceGroupName || input.app.config.resourceGroupName}/providers/Microsoft.Web/sites/${input.event.inputConfig.name}/slots/${input.event.inputConfig.slot}/perfcounters` +
...
export default WebApps_ListPerfMonCountersSlot;
