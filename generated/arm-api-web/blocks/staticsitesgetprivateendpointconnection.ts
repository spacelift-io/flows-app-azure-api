...
const StaticSites_GetPrivateEndpointConnection: AppBlock = {
  name: "Static Sites / Get Private Endpoint Connection",
...
export default StaticSites_GetPrivateEndpointConnection;
