...
const WebApps_UpdateDomainOwnershipIdentifierSlot: AppBlock = {
  name: "Web Apps / Update Domain Ownership Identifier Slot",
  description:
...
export default WebApps_UpdateDomainOwnershipIdentifierSlot;
