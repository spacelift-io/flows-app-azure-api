...
const WebApps_CreateOrUpdateVnetConnectionSlot: AppBlock = {
  name: "Web Apps / Create Or Update Vnet Connection Slot",
  description:
...
export default WebApps_CreateOrUpdateVnetConnectionSlot;
