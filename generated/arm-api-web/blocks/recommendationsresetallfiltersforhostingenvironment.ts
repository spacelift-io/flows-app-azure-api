...
const Recommendations_ResetAllFiltersForHostingEnvironment: AppBlock = {
  name: "Recommendations / Reset All Filters For Hosting Environment",
  description:
...
export default Recommendations_ResetAllFiltersForHostingEnvironment;
