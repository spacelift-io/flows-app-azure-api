...
const AppServiceEnvironments_GetDiagnosticsItem: AppBlock = {
  name: "App Service Environments / Get Diagnostics Item",
  description:
...
export default AppServiceEnvironments_GetDiagnosticsItem;
