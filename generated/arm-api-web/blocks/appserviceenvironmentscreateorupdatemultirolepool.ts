...
const AppServiceEnvironments_CreateOrUpdateMultiRolePool: AppBlock = {
  name: "App Service Environments / Create Or Update Multi Role Pool",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        const requestBody = input.event.inputConfig.multiRolePoolEnvelope;
...
export default AppServiceEnvironments_CreateOrUpdateMultiRolePool;
