...
const WebApps_CreateInstanceMSDeployOperation: AppBlock = {
  name: "Web Apps / Create Instance MS Deploy Operation",
...
export default WebApps_CreateInstanceMSDeployOperation;
