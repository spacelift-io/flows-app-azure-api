...
const AppServiceCertificateOrders_VerifyDomainOwnership: AppBlock = {
  name: "App Service Certificate Orders / Verify Domain Ownership",
  description:
...
export default AppServiceCertificateOrders_VerifyDomainOwnership;
