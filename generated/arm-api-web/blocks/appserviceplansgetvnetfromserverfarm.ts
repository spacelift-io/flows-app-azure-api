...
const AppServicePlans_GetVnetFromServerFarm: AppBlock = {
  name: "App Service Plans / Get Vnet From Server Farm",
  description:
...
export default AppServicePlans_GetVnetFromServerFarm;
