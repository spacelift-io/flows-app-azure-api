...
const WebApps_CreateOrUpdateHybridConnectionSlot: AppBlock = {
  name: "Web Apps / Create Or Update Hybrid Connection Slot",
  description:
...
export default WebApps_CreateOrUpdateHybridConnectionSlot;
