...
const AppServiceEnvironments_GetOutboundNetworkDependenciesEndpoints: AppBlock =
  {
    name: "App Service Environments / Get Outbound Network Dependencies Endpoints",
    description:
...
export default AppServiceEnvironments_GetOutboundNetworkDependenciesEndpoints;
