...
const StaticSites_GetUserProvidedFunctionAppForStaticSite: AppBlock = {
  name: "Static Sites / Get User Provided Function App For Static Site",
  description:
...
export default StaticSites_GetUserProvidedFunctionAppForStaticSite;
