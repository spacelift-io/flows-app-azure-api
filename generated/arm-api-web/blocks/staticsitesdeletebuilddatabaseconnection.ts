...
const StaticSites_DeleteBuildDatabaseConnection: AppBlock = {
  name: "Static Sites / Delete Build Database Connection",
...
export default StaticSites_DeleteBuildDatabaseConnection;
