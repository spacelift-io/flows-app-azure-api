...
const StaticSites_ApproveOrRejectPrivateEndpointConnection: AppBlock = {
  name: "Static Sites / Approve Or Reject Private Endpoint Connection",
  description:
...
export default StaticSites_ApproveOrRejectPrivateEndpointConnection;
