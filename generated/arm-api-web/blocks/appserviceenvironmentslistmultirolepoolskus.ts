...
const AppServiceEnvironments_ListMultiRolePoolSkus: AppBlock = {
  name: "App Service Environments / List Multi Role Pool Skus",
  description:
...
export default AppServiceEnvironments_ListMultiRolePoolSkus;
