...
const AppServiceEnvironments_GetPrivateEndpointConnection: AppBlock = {
  name: "App Service Environments / Get Private Endpoint Connection",
...
export default AppServiceEnvironments_GetPrivateEndpointConnection;
