...
const AppServiceCertificateOrders_CreateOrUpdateCertificate: AppBlock = {
  name: "App Service Certificate Orders / Create Or Update Certificate",
  description:
...
export default AppServiceCertificateOrders_CreateOrUpdateCertificate;
