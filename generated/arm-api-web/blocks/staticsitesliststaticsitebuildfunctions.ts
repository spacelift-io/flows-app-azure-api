...
const StaticSites_ListStaticSiteBuildFunctions: AppBlock = {
  name: "Static Sites / List Static Site Build Functions",
  description:
...
export default StaticSites_ListStaticSiteBuildFunctions;
