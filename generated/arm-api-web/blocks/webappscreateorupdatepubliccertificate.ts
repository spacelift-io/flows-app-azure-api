...
const WebApps_CreateOrUpdatePublicCertificate: AppBlock = {
  name: "Web Apps / Create Or Update Public Certificate",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const url =
          `https://management.azure.com/subscriptions/${input.event.inputConfig.subscriptionId || input.app.config.subscriptionId}/resourceGroups/${input.event.inputConfig.resourceGroupName || input.app.config.resourceGroupName}/providers/Microsoft.Web/sites/${input.event.inputConfig.name}/publicCertificates/${input.event.inputConfig.publicCertificateName}` +
...
export default WebApps_CreateOrUpdatePublicCertificate;
