...
const WebApps_UpdateVnetConnectionGatewaySlot: AppBlock = {
  name: "Web Apps / Update Vnet Connection Gateway Slot",
  description:
...
export default WebApps_UpdateVnetConnectionGatewaySlot;
