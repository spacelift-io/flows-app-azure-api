...
const AppServiceEnvironments_ListWorkerPoolInstanceMetricDefinitions: AppBlock =
  {
    name: "App Service Environments / List Worker Pool Instance Metric Definitions",
    description:
...
export default AppServiceEnvironments_ListWorkerPoolInstanceMetricDefinitions;
