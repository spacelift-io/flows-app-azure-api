...
const WebApps_UpdateSwiftVirtualNetworkConnectionWithCheckSlot: AppBlock = {
  name: "Web Apps / Update Swift Virtual Network Connection With Check Slot",
  description:
...
export default WebApps_UpdateSwiftVirtualNetworkConnectionWithCheckSlot;
