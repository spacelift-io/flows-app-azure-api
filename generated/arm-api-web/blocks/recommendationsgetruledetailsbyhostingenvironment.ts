...
const Recommendations_GetRuleDetailsByHostingEnvironment: AppBlock = {
  name: "Recommendations / Get Rule Details By Hosting Environment",
...
export default Recommendations_GetRuleDetailsByHostingEnvironment;
