...
const StaticSites_CreateZipDeploymentForStaticSiteBuild: AppBlock = {
  name: "Static Sites / Create Zip Deployment For Static Site Build",
  description:
...
export default StaticSites_CreateZipDeploymentForStaticSiteBuild;
