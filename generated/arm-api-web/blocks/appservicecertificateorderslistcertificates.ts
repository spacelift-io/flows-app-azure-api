...
const AppServiceCertificateOrders_ListCertificates: AppBlock = {
  name: "App Service Certificate Orders / List Certificates",
  description:
...
export default AppServiceCertificateOrders_ListCertificates;
