...
const AppServiceEnvironments_GetAseCustomDnsSuffixConfiguration: AppBlock = {
  name: "App Service Environments / Get Ase Custom Dns Suffix Configuration",
  description:
...
export default AppServiceEnvironments_GetAseCustomDnsSuffixConfiguration;
