...
const AppServicePlans_ListWebApps: AppBlock = {
  name: "App Service Plans / List Web Apps",
  description:
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        const url =
          `https://management.azure.com/subscriptions/${input.event.inputConfig.subscriptionId || input.app.config.subscriptionId}/resourceGroups/${input.event.inputConfig.resourceGroupName || input.app.config.resourceGroupName}/providers/Microsoft.Web/serverfarms/${input.event.inputConfig.name}/sites` +
...
export default AppServicePlans_ListWebApps;
