...
const Recommendations_ListRecommendedRulesForHostingEnvironment: AppBlock = {
  name: "Recommendations / List Recommended Rules For Hosting Environment",
  description:
...
export default Recommendations_ListRecommendedRulesForHostingEnvironment;
