...
const WorkflowRunActionRepetitions_List: AppBlock = {
  name: "Workflow Run Action Repetitions / List",
...
export default WorkflowRunActionRepetitions_List;
