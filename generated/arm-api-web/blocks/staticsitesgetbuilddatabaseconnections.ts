...
const StaticSites_GetBuildDatabaseConnections: AppBlock = {
  name: "Static Sites / Get Build Database Connections",
  description:
...
export default StaticSites_GetBuildDatabaseConnections;
