...
const AppServiceCertificateOrders_DeleteCertificate: AppBlock = {
  name: "App Service Certificate Orders / Delete Certificate",
  description:
...
export default AppServiceCertificateOrders_DeleteCertificate;
