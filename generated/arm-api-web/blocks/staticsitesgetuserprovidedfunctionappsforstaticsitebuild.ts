...
const StaticSites_GetUserProvidedFunctionAppsForStaticSiteBuild: AppBlock = {
  name: "Static Sites / Get User Provided Function Apps For Static Site Build",
  description:
...
export default StaticSites_GetUserProvidedFunctionAppsForStaticSiteBuild;
