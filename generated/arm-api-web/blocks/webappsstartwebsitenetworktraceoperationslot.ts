...
const WebApps_StartWebSiteNetworkTraceOperationSlot: AppBlock = {
  name: "Web Apps / Start Web Site Network Trace Operation Slot",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        const url =
          `https://management.azure.com/subscriptions/${input.event.inputConfig.subscriptionId || input.app.config.subscriptionId}/resourceGroups/${input.event.inputConfig.resourceGroupName || input.app.config.resourceGroupName}/providers/Microsoft.Web/sites/${input.event.inputConfig.name}/slots/${input.event.inputConfig.slot}/networkTrace/startOperation` +
...
export default WebApps_StartWebSiteNetworkTraceOperationSlot;
