...
const StaticSites_RegisterUserProvidedFunctionAppWithStaticSiteBuild: AppBlock =
  {
    name: "Static Sites / Register User Provided Function App With Static Site Build",
    description:
...
export default StaticSites_RegisterUserProvidedFunctionAppWithStaticSiteBuild;
