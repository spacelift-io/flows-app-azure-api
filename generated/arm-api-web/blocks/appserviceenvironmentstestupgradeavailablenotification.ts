...
const AppServiceEnvironments_TestUpgradeAvailableNotification: AppBlock = {
  name: "App Service Environments / Test Upgrade Available Notification",
  description:
...
export default AppServiceEnvironments_TestUpgradeAvailableNotification;
