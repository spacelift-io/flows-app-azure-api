...
const AppServiceEnvironments_ListMultiRoleMetricDefinitions: AppBlock = {
  name: "App Service Environments / List Multi Role Metric Definitions",
  description:
...
export default AppServiceEnvironments_ListMultiRoleMetricDefinitions;
