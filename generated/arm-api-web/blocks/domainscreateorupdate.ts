...
const Domains_CreateOrUpdate: AppBlock = {
  name: "Domains / Create Or Update",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        const requestBody = input.event.inputConfig.domain;
...
export default Domains_CreateOrUpdate;
