...
const WebApps_CreateOrUpdateSiteContainerSlot: AppBlock = {
  name: "Web Apps / Create Or Update Site Container Slot",
  description:
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        const url =
          `https://management.azure.com/subscriptions/${input.event.inputConfig.subscriptionId || input.app.config.subscriptionId}/resourceGroups/${input.event.inputConfig.resourceGroupName || input.app.config.resourceGroupName}/providers/Microsoft.Web/sites/${input.event.inputConfig.name}/slots/${input.event.inputConfig.slot}/sitecontainers/${input.event.inputConfig.containerName}` +
...
export default WebApps_CreateOrUpdateSiteContainerSlot;
