...
const StaticSites_CreateOrUpdateStaticSiteBuildAppSettings: AppBlock = {
  name: "Static Sites / Create Or Update Static Site Build App Settings",
  description:
...
export default StaticSites_CreateOrUpdateStaticSiteBuildAppSettings;
