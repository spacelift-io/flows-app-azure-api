...
const WebApps_ListPublishingProfileXmlWithSecretsSlot: AppBlock = {
  name: "Web Apps / List Publishing Profile Xml With Secrets Slot",
  description:
...
export default WebApps_ListPublishingProfileXmlWithSecretsSlot;
