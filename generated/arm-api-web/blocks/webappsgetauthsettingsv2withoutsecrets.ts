...
const WebApps_GetAuthSettingsV2WithoutSecrets: AppBlock = {
  name: "Web Apps / Get Auth Settings V2Without Secrets",
  description:
...
export default WebApps_GetAuthSettingsV2WithoutSecrets;
