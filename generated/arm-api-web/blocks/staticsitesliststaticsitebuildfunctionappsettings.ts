...
const StaticSites_ListStaticSiteBuildFunctionAppSettings: AppBlock = {
  name: "Static Sites / List Static Site Build Function App Settings",
  description:
...
export default StaticSites_ListStaticSiteBuildFunctionAppSettings;
