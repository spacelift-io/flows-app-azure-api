...
const AppServiceEnvironments_GetPrivateEndpointConnectionList: AppBlock = {
  name: "App Service Environments / Get Private Endpoint Connection List",
  description:
...
export default AppServiceEnvironments_GetPrivateEndpointConnectionList;
