...
const StaticSites_GetBuildDatabaseConnection: AppBlock = {
  name: "Static Sites / Get Build Database Connection",
  description:
...
export default StaticSites_GetBuildDatabaseConnection;
