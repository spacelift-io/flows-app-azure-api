...
const StaticSites_GetStaticSiteCustomDomain: AppBlock = {
  name: "Static Sites / Get Static Site Custom Domain",
  description:
...
export default StaticSites_GetStaticSiteCustomDomain;
