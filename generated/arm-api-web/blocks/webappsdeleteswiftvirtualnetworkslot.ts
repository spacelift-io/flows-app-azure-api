...
const WebApps_DeleteSwiftVirtualNetworkSlot: AppBlock = {
  name: "Web Apps / Delete Swift Virtual Network Slot",
  description:
...
export default WebApps_DeleteSwiftVirtualNetworkSlot;
