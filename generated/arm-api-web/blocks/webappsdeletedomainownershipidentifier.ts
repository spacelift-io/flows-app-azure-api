...
const WebApps_DeleteDomainOwnershipIdentifier: AppBlock = {
  name: "Web Apps / Delete Domain Ownership Identifier",
  description:
...
export default WebApps_DeleteDomainOwnershipIdentifier;
