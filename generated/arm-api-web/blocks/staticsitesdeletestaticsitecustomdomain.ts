...
const StaticSites_DeleteStaticSiteCustomDomain: AppBlock = {
  name: "Static Sites / Delete Static Site Custom Domain",
...
export default StaticSites_DeleteStaticSiteCustomDomain;
