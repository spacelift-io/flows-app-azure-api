...
const StaticSites_CreateOrUpdateBuildDatabaseConnection: AppBlock = {
  name: "Static Sites / Create Or Update Build Database Connection",
  description:
...
export default StaticSites_CreateOrUpdateBuildDatabaseConnection;
