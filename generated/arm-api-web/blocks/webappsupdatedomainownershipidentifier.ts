...
const WebApps_UpdateDomainOwnershipIdentifier: AppBlock = {
  name: "Web Apps / Update Domain Ownership Identifier",
  description:
...
export default WebApps_UpdateDomainOwnershipIdentifier;
