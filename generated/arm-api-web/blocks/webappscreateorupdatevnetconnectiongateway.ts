...
const WebApps_CreateOrUpdateVnetConnectionGateway: AppBlock = {
  name: "Web Apps / Create Or Update Vnet Connection Gateway",
  description:
...
export default WebApps_CreateOrUpdateVnetConnectionGateway;
