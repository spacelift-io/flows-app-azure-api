...
const StaticSites_GetDatabaseConnectionWithDetails: AppBlock = {
  name: "Static Sites / Get Database Connection With Details",
  description:
...
export default StaticSites_GetDatabaseConnectionWithDetails;
