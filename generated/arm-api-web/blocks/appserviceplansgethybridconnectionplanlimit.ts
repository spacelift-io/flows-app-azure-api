...
const AppServicePlans_GetHybridConnectionPlanLimit: AppBlock = {
  name: "App Service Plans / Get Hybrid Connection Plan Limit",
  description:
...
export default AppServicePlans_GetHybridConnectionPlanLimit;
