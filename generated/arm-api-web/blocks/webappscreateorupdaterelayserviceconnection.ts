...
const WebApps_CreateOrUpdateRelayServiceConnection: AppBlock = {
  name: "Web Apps / Create Or Update Relay Service Connection",
  description:
...
export default WebApps_CreateOrUpdateRelayServiceConnection;
