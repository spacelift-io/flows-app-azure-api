...
const AppServiceEnvironments_ApproveOrRejectPrivateEndpointConnection: AppBlock =
  {
    name: "App Service Environments / Approve Or Reject Private Endpoint Connection",
    description:
...
export default AppServiceEnvironments_ApproveOrRejectPrivateEndpointConnection;
