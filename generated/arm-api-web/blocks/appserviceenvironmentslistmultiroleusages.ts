...
const AppServiceEnvironments_ListMultiRoleUsages: AppBlock = {
  name: "App Service Environments / List Multi Role Usages",
  description:
...
export default AppServiceEnvironments_ListMultiRoleUsages;
