...
const AppServiceCertificateOrders_GetCertificate: AppBlock = {
  name: "App Service Certificate Orders / Get Certificate",
  description:
...
export default AppServiceCertificateOrders_GetCertificate;
