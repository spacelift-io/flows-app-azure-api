...
const StaticSites_GetBuildDatabaseConnectionWithDetails: AppBlock = {
  name: "Static Sites / Get Build Database Connection With Details",
  description:
...
export default StaticSites_GetBuildDatabaseConnectionWithDetails;
