...
const AppServiceEnvironments_CreateOrUpdateWorkerPool: AppBlock = {
  name: "App Service Environments / Create Or Update Worker Pool",
...
export default AppServiceEnvironments_CreateOrUpdateWorkerPool;
