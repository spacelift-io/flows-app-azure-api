...
const ConfigurationStores_Update: AppBlock = {
  name: "Configuration Stores / Update",
    ...
    default: {
      config: {
        ...
        configStoreUpdateParameters: {
          name: "Config Store Update Parameters",
          type: {
            type: "object",
            properties: {
              properties: {
      ...
      onEvent: async (input) => {
        const requestBody = input.event.inputConfig.configStoreUpdateParameters;
...
export default ConfigurationStores_Update;
