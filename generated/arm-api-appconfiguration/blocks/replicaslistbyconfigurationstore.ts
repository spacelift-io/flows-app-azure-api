...
const Replicas_ListByConfigurationStore: AppBlock = {
  name: "Replicas / List By Configuration Store",
...
export default Replicas_ListByConfigurationStore;
