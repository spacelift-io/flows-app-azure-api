...
const Replicas_Create: AppBlock = {
  name: "Replicas / Create",
    ...
    default: {
      config: {
        ...
        replicaCreationParameters: {
          name: "Replica Creation Parameters",
          type: {
            type: "object",
            properties: {
              id: {
      ...
      onEvent: async (input) => {
        const requestBody = input.event.inputConfig.replicaCreationParameters;
...
export default Replicas_Create;
