...
const PrivateLinkResources_ListByConfigurationStore: AppBlock = {
  name: "Private Link Resources / List By Configuration Store",
  description:
...
export default PrivateLinkResources_ListByConfigurationStore;
